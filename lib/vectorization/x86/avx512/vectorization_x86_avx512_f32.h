...
#define vec_loadu_maskedz_f32_32(ptr, mask)                vec_loop_expr(vec_f32_32_t, 2, _tmp, _i, (_tmp).v[_i] = _mm512_maskz_loadu_ps((mask).v[_i], ((__m512 *) (ptr)) + _i);)
#define vec_loadu_maskedz_f32_16(ptr, mask)                vec_f32_16( _mm512_maskz_loadu_ps((mask).v, (__m512 *) (ptr)) )
#define vec_loadu_maskedz_f32_8(ptr, mask)                 vec_f32_8( _mm256_maskz_loadu_ps((mask).v, (__m256 *) (ptr)) )
#define vec_loadu_maskedz_f32_4(ptr, mask)                 vec_f32_4( _mm_maskz_loadu_ps((mask).v, (__m128 *) (ptr)) )
...
#define vec_storeu_masked_f32_32(ptr, vec, mask)           vec_loop_stmt(4, _i, _mm512_mask_storeu_ps(((__m512 *) (ptr)) + _i, (mask).v[_i], (vec).v[_i]);)
#define vec_storeu_masked_f32_16(ptr, vec, mask)           _mm512_mask_storeu_ps((__m512 *) (ptr), (mask).v, (vec).v)
#define vec_storeu_masked_f32_8(ptr, vec, mask)            _mm256_mask_storeu_ps((__m256 *) (ptr), (mask).v, (vec).v)
#define vec_storeu_masked_f32_4(ptr, vec, mask)            _mm_mask_storeu_ps((__m128 *) (ptr), (mask).v, (vec).v)
...
#define vec_gather_f32_i32_16(ptr, idx)                    vec_f32_16( _mm512_i32gather_ps((idx).v, (float *) (ptr), 4) )
...
#define vec_gather_f32_i64_16(ptr, idx)                    vec_f32_16( _mm512_i64gather_ps((idx).v, (float *) (ptr), 4) )
