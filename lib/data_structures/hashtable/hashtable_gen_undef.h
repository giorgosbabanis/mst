...
#undef              HASHTABLE_GEN_VALUE_SAME_AS_KEY
#undef              HASHTABLE_GEN_KEY_IS_REF
#undef              HASHTABLE_GEN_TYPE_1
#undef              HASHTABLE_GEN_TYPE_2
#undef              HASHTABLE_GEN_TYPE_3
#undef              HASHTABLE_GEN_SUFFIX
#undef              HASHTABLE_GEN_FUNCTION_ATTRIBUTES
#undef              HASHTABLE_GEN_EXPAND
#undef              HASHTABLE_GEN_EXPAND_TYPE
